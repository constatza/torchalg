...
from ..amg.smoothers import JacobiSmoother
...
def apply_jacobi_damping(
    ...
    *,
    ...
    reimplementing the Jacobi iteration - this is the one place both
    ``smoother_persistence_scales`` (weighting) and any snapshot-generation
    strategy that wants "algebraically smooth" probe vectors should call.
